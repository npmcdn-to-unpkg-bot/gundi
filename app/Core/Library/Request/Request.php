...
class Request implements IRequest
{
    ...
    public function send($sUrl, $aPost = array(), $sMethod = 'POST', $sUserAgent = null, $aCookies = null, $bFollow = false)
    {
        ...
        if (extension_loaded('curl') && function_exists('curl_init')) {
            ...
            curl_setopt($hCurl, CURLOPT_USERAGENT, ($sUserAgent === null ? "" . Gundi::BROWSER_AGENT . " (" . Gundi::getVersion() . ")" : $sUserAgent));
        ...
        if (!isset($sData)) {
            ...
            if (!$hConnection) {
                ...
                $sSend .= "User-Agent: " . Gundi::BROWSER_AGENT . " (" . Gundi::getVersion() . ")\r\n";
